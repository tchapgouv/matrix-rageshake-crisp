...
def start_cron():
    ...
    job_export_segments_history_in_days:str = os.environ["JOB_EXPORT_SEGMENTS_HISTORY_IN_DAYS"]
    ...
    logging.info(f'Configure job_export_segments_history_in_days with : {job_export_segments_history_in_days}')
